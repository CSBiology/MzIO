...
[<assembly: AssemblyVersionAttribute("0.0.9.3")>]
[<assembly: AssemblyFileVersionAttribute("0.0.9.3")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "0.0.9.3"
    let [<Literal>] AssemblyFileVersion = "0.0.9.3"
