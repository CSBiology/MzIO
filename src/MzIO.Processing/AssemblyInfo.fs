...
[<assembly: AssemblyVersionAttribute("0.0.9.2")>]
[<assembly: AssemblyFileVersionAttribute("0.0.9.2")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "0.0.9.2"
    let [<Literal>] AssemblyFileVersion = "0.0.9.2"
