...
[<assembly: AssemblyVersionAttribute("0.0.8.1")>]
[<assembly: AssemblyFileVersionAttribute("0.0.8.1")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "0.0.8.1"
    let [<Literal>] AssemblyFileVersion = "0.0.8.1"
