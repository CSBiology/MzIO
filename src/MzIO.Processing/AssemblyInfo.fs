...
[<assembly: AssemblyVersionAttribute("0.0.9.5")>]
[<assembly: AssemblyFileVersionAttribute("0.0.9.5")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "0.0.9.5"
    let [<Literal>] AssemblyFileVersion = "0.0.9.5"
