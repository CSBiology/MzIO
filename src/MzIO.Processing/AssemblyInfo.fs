...
[<assembly: AssemblyVersionAttribute("0.0.9.9")>]
[<assembly: AssemblyFileVersionAttribute("0.0.9.9")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "0.0.9.9"
    let [<Literal>] AssemblyFileVersion = "0.0.9.9"
