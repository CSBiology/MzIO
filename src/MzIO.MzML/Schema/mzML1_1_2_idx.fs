...
namespace MzML_Idx_1_1_2
    ...
    exception ReturnException95c49a2fa123453e9c42738bc4986282 of obj
    exception ReturnNoneException95c49a2fa123453e9c42738bc4986282
    [<AutoOpen>]
    module FuncConvertFinalOverload95c49a2fa123453e9c42738bc4986282 =
    ...
    and
        ...
        (* partial *)IndexListType = class
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable indexField:IndexType[]
            
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable countField:string
            /// <remarks/>
            
            abstract index : IndexType[] with get,set
            [<System.Xml.Serialization.XmlElementAttribute("index")>]
            
            default this.index
                with get() : IndexType[] =
                    ((this.indexField :> obj) :?> IndexType[])
                and set(value:IndexType[]) : unit =
                    this.indexField <- value
    ...
    and
        ...
        (* partial *)IndexType = class
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable offsetField:OffsetType[]
            
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable nameField:IndexTypeName
            /// <remarks/>
            
            abstract offset : OffsetType[] with get,set
            [<System.Xml.Serialization.XmlElementAttribute("offset")>]
            
            default this.offset
                with get() : OffsetType[] =
                    ((this.offsetField :> obj) :?> OffsetType[])
                and set(value:OffsetType[]) : unit =
                    this.offsetField <- value
            
            /// <remarks/>
            
            abstract name : IndexTypeName with get,set
            [<System.Xml.Serialization.XmlAttributeAttribute>]
            
            default this.name
                with get() : IndexTypeName =
                    ((this.nameField :> obj) :?> IndexTypeName)
                and set(value:IndexTypeName) : unit =
                    this.nameField <- value
        end
    ...
    and
        ...
        (* partial *)OffsetType = class
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable idRefField:string
            
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable spotIDField:string
            
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable scanTimeField:float
            
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable scanTimeFieldSpecified:bool
            
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable valueField:int64
            /// <remarks/>
            
            abstract idRef : string with get,set
            [<System.Xml.Serialization.XmlAttributeAttribute>]
            ...
            abstract scanTime : float with get,set
            [<System.Xml.Serialization.XmlAttributeAttribute>]
            
            default this.scanTime
                with get() : float =
                    this.scanTimeField
            ...
            abstract scanTimeSpecified : bool with get,set
            [<System.Xml.Serialization.XmlIgnoreAttribute>]
            
            default this.scanTimeSpecified
                with get() : bool =
                    this.scanTimeFieldSpecified
                and set(value:bool) : unit =
                    this.scanTimeFieldSpecified <- value
            
            /// <remarks/>
            
            abstract Value : int64 with get,set
            [<System.Xml.Serialization.XmlTextAttribute>]
            
            default this.Value
                with get() : int64 =
                    this.valueField
                and set(value:int64) : unit =
                    this.valueField <- value
        end
    ...
    and
        ...
        (* partial *)indexedmzML = class
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable mzMLField:mzMLType
            
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable indexListField:IndexListType
            
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable indexListOffsetField:System.Nullable<int64>
            
            [<Microsoft.FSharp.Core.DefaultValueAttribute(false)>]
            val mutable fileChecksumField:string
            /// <remarks/>
            
            abstract mzML : mzMLType with get,set
            default this.mzML
                with get() : mzMLType =
                    ((this.mzMLField :> obj) :?> mzMLType)
                and set(value:mzMLType) : unit =
                    this.mzMLField <- value
            
            /// <remarks/>
            
            abstract indexList : IndexListType with get,set
            default this.indexList
                with get() : IndexListType =
                    ((this.indexListField :> obj) :?> IndexListType)
                and set(value:IndexListType) : unit =
                    this.indexListField <- value
            
            /// <remarks/>
            
            abstract indexListOffset : System.Nullable<int64> with get,set
            [<System.Xml.Serialization.XmlElementAttribute(IsNullable=true)>]
            
            default this.indexListOffset
                with get() : System.Nullable<int64> =
                    ((this.indexListOffsetField :> obj) :?> System.Nullable<int64>)
                and set(value:System.Nullable<int64>) : unit =
                    this.indexListOffsetField <- value
            
            /// <remarks/>
            
            abstract fileChecksum : string with get,set
            default this.fileChecksum
                with get() : string =
                    this.fileChecksumField
                and set(value:string) : unit =
